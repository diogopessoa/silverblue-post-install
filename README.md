...
* **Media & Utilities:** Gapless (Music), LocalSend (share files), Loupe (Image Viewer), Evince (Document Viewer), Showtime (Video Player), Snapshot (Camera), SimpleScan, Smile (Emojis).
